...
sample_env = BASE_DIR / 'env.sample'
if env_file.exists():
    environ.Env.read_env(env_file)
elif sample_env.exists():
    environ.Env.read_env(sample_env)
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='mailer@example.com')
